#!/usr/bin/env bash
# Deploy clutch-card-football to production using GitHub as the source of truth.
...
REMOTE="${REMOTE:-/opt/clutch-card-football}"
...
echo "✓ Deployed to https://ccf.norangio.dev"
